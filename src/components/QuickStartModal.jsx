...
// Kompakt genväg för spelare som kryssat "Visa inte denna text igen" på ett
// spels förklaringsskärm (GameInfoScreen) — samma Starta/Tillbaka-val, men
// utan den fullständiga regeltexten. "Instruktioner" leder tillbaka dit.
export default function QuickStartModal({ title, onStart, onBack, onInstructions }) {
  return (
